...
export default function Nav() {
  ...
  return (
    <nav
      ...
      className={`absolute w-full z-20 py-[30px] px-4 bg-transparent`}
    >
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <div className="flex items-center gap-[50px]">
          ...
          <div className="hidden lg:flex items-center gap-6">
            <Link
              className={`font-semibold text-lg text-white xl:hover:text-main transition-all duration-100 tracking-[3px]`}
              href="/"
            >
              {t("home")}
            </Link>
            ...
            <div className="relative z-10 group">
              <button
                className={`flex items-center gap-1 font-semibold text-white text-lg xl:hover:text-main transition-all duration-100 tracking-[3px]`}
              >
                {t("whoweare")}
                <span>
                  <svg
